...
import { AnimatedCard, Navigation } from "../NavigationCards/styles";

import { Container as ButtonContainer } from "../../../../components/Button/styles";

const backgroundSrc = new URL(
  "../../../../assets/images/illustrations/button-background.svg",
  import.meta.url
).href;
...
export const EquitySection = styled.article`
  ${({ theme }) => css`
    ...
    border-radius: ${theme.radii.default};
    background: url(${backgroundSrc}), ${theme.colors.primaryDark};
